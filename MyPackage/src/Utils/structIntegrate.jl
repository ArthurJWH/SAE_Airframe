...
function (integrateglq::IntegrateGLQ)(a::AbstractFloat, b::AbstractFloat)
    return evaluate(integrateglq, a, b)
end

@inline function evaluate(
    integrateglq::IntegrateGLQ, a::AbstractFloat, b::AbstractFloat
)
